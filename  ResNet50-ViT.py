...
class ClassToken(Layer): # layer to create a class token for the transformer
    def __init__(self,):
        super().__init__()

    def build(self, input_shape): # build method to initialize the class token variable
